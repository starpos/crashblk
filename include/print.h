...
#endif
#define PRINTV_E(fmt, args...) PRINT_E("(%s) " fmt, __func__, ##args)
#define PRINTV_W(fmt, args...) PRINT_W("(%s) " fmt, __func__, ##args)
#define PRINTV_N(fmt, args...) PRINT_N("(%s) " fmt, __func__, ##args)
#define PRINTV_I(fmt, args...) PRINT_I("(%s) " fmt, __func__, ##args)
#define PRINTV_D(fmt, args...) PRINT_D(					\
		"(%s:%d:%s) " fmt, SRC_FILE, __LINE__, __func__, ##args)
#else /* __KERNEL__ */
#include <stdio.h>
#ifdef DEBUG
